...
module unsaved_mm_interconnect_0 (
	...
	wire  [94:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> nios2_gen2_0_debug_mem_slave_agent:cp_data
	...
	wire  [94:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> onchip_memory2_0_s1_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                              // onchip_memory2_0_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [3:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> onchip_memory2_0_s1_agent:cp_channel
	...
	wire  [20:0] uart_0_s1_agent_m0_address;                                                         // uart_0_s1_agent:m0_address -> uart_0_s1_translator:uav_address
	...
	wire  [94:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> uart_0_s1_agent:cp_data
	...
	wire  [94:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> pio_0_s1_agent:cp_data
	...
	wire  [94:0] nios2_gen2_0_debug_mem_slave_agent_rp_data;                                         // nios2_gen2_0_debug_mem_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [94:0] onchip_memory2_0_s1_agent_rp_data;                                                  // onchip_memory2_0_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [94:0] uart_0_s1_agent_rp_data;                                                            // uart_0_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [94:0] pio_0_s1_agent_rp_data;                                                             // pio_0_s1_agent:rp_data -> router_005:sink_data
	...
	wire         uart_0_s1_agent_rdata_fifo_src_valid;                                               // uart_0_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] uart_0_s1_agent_rdata_fifo_src_data;                                                // uart_0_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         uart_0_s1_agent_rdata_fifo_src_ready;                                               // avalon_st_adapter_002:in_0_ready -> uart_0_s1_agent:rdata_fifo_src_ready
	...
	unsaved_mm_interconnect_0_cmd_demux_001 rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
